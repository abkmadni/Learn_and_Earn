        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(15),
                child: cer(num: provider.prefs.getString('phone') ,),
              ),

              Container(
                  padding: const EdgeInsets.all(15),
                  child: accountinfo(title: "Phone : ",name:provider.prefs.getString("phone"),icon: Icons.call,)
              ),
              ...
              InkWell(
                onTap: (){
                  Navigator.push(context, PageTransition(
                      child: const certificateview(), type: PageTransitionType.fade));
                },
                child : Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Certificate',style: GoogleFonts.roboto(fontSize: AppLayout.getwidth(context)*0.04),),
                      )
                    ],
                  ),
                ),
                ...
                child : Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 18.0),
                        child: Text('Faqs',style: GoogleFonts.roboto(fontSize: AppLayout.getwidth(context)*0.04),),
                      )
                    ],
                  ),
                ),
