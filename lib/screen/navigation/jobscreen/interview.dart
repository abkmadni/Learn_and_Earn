          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                cer(num: data['appliedby'],),

                const SizedBox(height: 10,),

                Text(data['title'],style: GoogleFonts.poppins(
                  fontWeight: FontWeight.w600,fontSize: AppLayout.getwidth(context)*0.05
                )),

                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10.0),
                  child: Text(data['des'],style: GoogleFonts.poppins(),),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Interview link',style: GoogleFonts.roboto(fontWeight: FontWeight.bold,fontSize: AppLayout.getwidth(context)*0.04),),
                      TextFormField(
                        maxLines: null,
                        onChanged: (val){
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('Date Time',style: GoogleFonts.roboto(fontWeight: FontWeight.bold,fontSize: AppLayout.getwidth(context)*0.04),),
                      TextFormField(
                        onChanged: (val){
                          provider.pass = val;
                        },
                ...
                InkWell(
                  onTap: (){
                    if(provider.confirm == "" || provider.pass == ""){
                      AppLayout.showsnakbar(context, 'Add Interview link and Date Time');
                    }else{
                      ...
                      key.set({
                        ...
                        provider.database.child('applyjob').child(keyval).remove();
                  ...
                  child: Container(
                    ...
                    child: Center(
                        child: Text('hire',style: GoogleFonts.poppins(
                          color: col.wh,fontWeight: FontWeight.w600,
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Container(
                    ...
                    child: Center(
                      child: Text(s[k.elementAt(index)]['title'].toString(),style: GoogleFonts.poppins(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(snapshot.data['name'],style: GoogleFonts.poppins(
                          color: col.wh,fontWeight: FontWeight.w600,
                          fontSize: AppLayout.getwidth(context)*0.05,
                        ),),
                        ...
                        Row(
                          children: [
                            const Icon(Icons.transgender,color: col.wh,),
                        ...
                        Row(
                          children: [
                            const Icon(Icons.school_outlined,color: col.wh,),
                            const SizedBox(width: 5,),
                            Text(snapshot.data['edu'],style: GoogleFonts.poppins(
                              color: col.wh,
                              fontSize: AppLayout.getwidth(context)*0.035,
                            ),),
                          ],
