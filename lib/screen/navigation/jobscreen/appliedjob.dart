                    ...
                    children: [
                      Container(
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            Tab(child: Text('New',style: GoogleFonts.poppins(fontWeight: FontWeight.w600,
                            fontSize: AppLayout.getwidth(context)*0.05 ),),),
                            Tab(child: Text('Old',style: GoogleFonts.poppins(fontWeight: FontWeight.w600,
                                fontSize: AppLayout.getwidth(context)*0.05 ),),),
                          ],
                        ),
                      ),
                          ...
                          children: [
                            FirebaseAnimatedList(
                                  ...
                                  itemBuilder:(BuildContext context, DataSnapshot snapshot, Animation<double> animation, int index){
                                    ...
                                    if (data['added'] == provider.prefs.getString('phone') ){
                                      return jobcontainer(data: data,inter: false,keyval:snapshot.key.toString());
                                    }else{
    ...
    return Container(
        ...
        child: Row(
          children: [
            ...
            const CircleAvatar(
              child: Icon(Icons.done ,color: col.wh,),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(data['link'].toString(),style: GoogleFonts.poppins(fontSize: AppLayout.getwidth(context)*0.04
                      ,fontWeight: FontWeight.bold),),
                  Text(data['time'].toString(),style: GoogleFonts.poppins(fontSize: AppLayout.getwidth(context)*0.03),)
                ],
              ),
            ),
